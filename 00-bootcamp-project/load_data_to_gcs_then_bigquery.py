...
keyfile_gcs = "deb-1-by-skooldio-93a5-gcs.json"
service_account_info_gcs = json.load(open(keyfile_gcs))
credentials_gcs = service_account.Credentials.from_service_account_info(service_account_info_gcs)

# this account should be both access to bigquery and gcs
keyfile_bigquery = "deb-1-by-skooldio-9c5d-bigquery.json"
