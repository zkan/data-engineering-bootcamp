...
def _load_data_to_gcs():
    keyfile_gcs = "/opt/spark/pyspark/deb-load-data-to-gcs.json"
    ...
    bucket_name = "deb-bootcamp-99-kan"
...
def _load_data_from_gcs_to_bigquery():
    keyfile_bigquery = "/opt/spark/pyspark/deb-load-data-to-bq-secured.json"
