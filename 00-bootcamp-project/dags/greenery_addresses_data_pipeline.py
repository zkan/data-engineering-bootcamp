...
def _load_data_to_gcs():
    keyfile_gcs = f"{DAGS_FOLDER}/dataengineercafe-deb4-uploading-files-to-gcs-27269bc8f45c.json"
...
def _load_data_from_gcs_to_bigquery():
    keyfile_bigquery = f"{DAGS_FOLDER}/dataengineercafe-deb4-load-files-to-bigquery-secured-4af392db6641.json"
