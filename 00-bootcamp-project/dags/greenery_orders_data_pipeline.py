...
def _load_data_to_gcs(ds):
    keyfile_gcs = f"{DAGS_FOLDER}/dataengineercafe-deb-uploading-files-to-gcs-77ed8fc646bf.json"
...
def _load_data_from_gcs_to_bigquery(ds):
    keyfile_bigquery = f"{DAGS_FOLDER}/dataengineercafe-deb-loading-data-to-bq-secured-d04e17d735e0.json"
...
with DAG(
    ...
    transform_data = SparkSubmitOperator(
        ...
        application="/opt/spark/pyspark/transform_orders.py",
        conn_id="my_spark",
